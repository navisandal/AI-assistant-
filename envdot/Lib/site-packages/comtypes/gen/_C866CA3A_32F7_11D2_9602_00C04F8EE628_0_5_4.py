...
__all__ = [
    'SAFT11kHz8BitMono', 'DISPID_SRRTTickCount', 'ISpRecoGrammar2',
    'DISPID_SABufferNotifySize', 'ISpeechObjectTokenCategory',
    'DISPID_SPIAudioSizeBytes', 'SDTDisplayText', 'SpVoice',
    'SPCT_DICTATION', 'SSFMCreate', 'SPPS_RESERVED2',
    'SRERecognition', 'SRESoundStart', 'SP_VISEME_20',
    'SpeechPropertyLowConfidenceThreshold', 'SPSFunction', 'SASPause',
    'SVSFParseSsml', 'SPSERIALIZEDPHRASE', 'SPEI_WORD_BOUNDARY',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SVEStreamStart',
    'IEnumSpObjectTokens', 'DISPID_SpeechPhraseReplacement',
    'DISPIDSPTSI_ActiveOffset', 'SP_VISEME_0', 'SPPS_Unknown',
    'ISpVoice', 'SGRSTTTextBuffer', 'DISPID_SDKEnumValues',
    'DISPID_SPRText', 'SDTRule', 'SPEI_RESERVED3', 'SGDSActive',
    'DISPID_SRGSetTextSelection', 'DISPID_SPIReplacements',
    'SVF_Stressed', 'DISPID_SGRSAddSpecialTransition',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SVGetProfiles', 'DISPID_SRCEventInterests', 'SPAS_PAUSE',
    'SVP_19', 'DISPID_SGRSTsItem', 'ISpeechLexiconWord',
    'SPEI_START_SR_STREAM', 'SGSExclusive',
    'DISPID_SVSCurrentStreamNumber', 'eLEXTYPE_MORPHOLOGY',
    'SP_VISEME_8', 'SpeechTokenKeyAttributes', 'DISPID_SPRuleParent',
    'SP_VISEME_1', 'SPEI_INTERFERENCE', '__MIDL_IWinTypes_0009',
    'SDTProperty', 'ISpeechRecoResult', 'DISPID_SLPsCount',
    'SpNotifyTranslator', 'eLEXTYPE_PRIVATE8', 'SPEI_TTS_PRIVATE',
    'DISPID_SpeechAudioStatus', 'SAFT16kHz16BitMono', 'SPSModifier',
    'SpeechCategoryAudioOut', 'ISpeechPhraseReplacement',
    'STCInprocHandler', 'SSSPTRelativeToStart', 'SP_VISEME_11',
    'SAFTGSM610_11kHzMono', 'DISPID_SPRuleNumberOfElements',
    'SpeechGrammarState', 'SPRECORESULTTIMES',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SpeechDataKey',
    'SVSFIsNotXML', 'DISPID_SGRsItem', 'SPCT_SUB_DICTATION',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPPParent',
    'DISPID_SVDisplayUI', 'DISPID_SPEAudioSizeTime',
    'Speech_StreamPos_RealTime', 'ISpeechDataKey', 'SPCATEGORYTYPE',
    'DISPID_SVEStreamEnd', 'SGRSTTEpsilon', 'DISPID_SVSRunningState',
    'DISPID_SVAlertBoundary', 'SpeechBookmarkOptions',
    'SPLOADOPTIONS', 'DISPID_SWFEExtraData',
    'DISPID_SOTGetStorageFileName', 'SpeechEngineProperties',
    'DISPID_SpeechPhraseProperties', 'DISPID_SAFGetWaveFormatEx',
    'SpeechLoadOption', 'DISPID_SASCurrentSeekPosition',
    'ISpRecognizer', 'SpeechRecoProfileProperties', 'DISPID_SRCState',
    'SpeechVoiceSpeakFlags', 'SAFT16kHz16BitStereo',
    'eLEXTYPE_RESERVED4', 'SPFM_CREATE', 'SPEI_RECOGNITION',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SP_VISEME_6',
    'SAFT22kHz16BitStereo', 'SPXMLRESULTOPTIONS', 'SpeechMicTraining',
    'SpPhraseInfoBuilder', 'ISpeechAudioStatus',
    'DISPID_SRRGetXMLErrorInfo', 'SpSharedRecognizer',
    'SPSERIALIZEDRESULT', 'SAFTCCITT_uLaw_22kHzMono', 'SSTTDictation',
    'DISPID_SWFEChannels', 'DISPID_SDKOpenKey',
    'SpPhoneticAlphabetConverter', 'SREAdaptation', 'SLTApp',
    'ISpeechRecognizer', 'SAFT12kHz16BitMono', 'SAFT22kHz16BitMono',
    'SGSDisabled', 'DISPID_SVAudioOutputStream',
    ...
    'ISpeechPhoneConverter', 'SPPHRASEELEMENT', 'ISpRecognizer3',
    'SAFT11kHz16BitMono', 'SAFT44kHz16BitStereo',
    'SVSFPurgeBeforeSpeak', 'SREFalseRecognition', 'DISPID_SBSRead',
    'SpeechGrammarRuleStateTransitionType', 'SPRULE',
    'DISPID_SLWPronunciations', 'SAFT32kHz16BitStereo',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVSFUnusedFlags',
    'DISPID_SGRInitialState', 'SDA_Consume_Leading_Spaces',
    'SDTAudio', 'SGLexicalNoSpecialChars',
    'DISPID_SRCSetAdaptationData', 'SREBookmark', 'SRERequestUI',
    'SPCONTEXTSTATE', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SVResume', 'SpUnCompressedLexicon', 'SVP_11',
    'DISPID_SVSPhonemeId', 'DISPID_SpeechXMLRecoResult',
    'ISpeechPhraseProperty', 'SECLowConfidence', 'ISpEventSource',
    'ISpeechRecoResult2', 'DISPID_SLPPartOfSpeech',
    'SPDKL_CurrentConfig', 'DISPID_SOTsCount',
    'ISpeechGrammarRuleState', 'DISPID_SVEViseme',
    'DISPID_SWFEFormatTag', 'SPAS_STOP', 'SPEVENT',
    'SVSFNLPSpeakPunc', 'SINoSignal', 'DISPID_SRSAudioStatus',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SDKGetBinaryValue',
    'eLEXTYPE_PRIVATE9', 'SPSHORTCUTPAIRLIST',
    'SpeechSpecialTransitionType', 'ISpeechBaseStream', 'SVP_6',
    'SPINTERFERENCE_NOISE', 'ISpeechMemoryStream', 'SREStateChange',
    'DISPID_SAFGuid', 'SAFT8kHz16BitMono', 'SAFT16kHz8BitStereo',
    'SAFTCCITT_uLaw_8kHzMono', 'SWTDeleted', 'SpeechWordType',
    'DISPID_SVSInputWordPosition', 'SVEStartInputStream',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPRulesItem', 'SpeechPartOfSpeech',
    'SPWORDPRONUNCIATION', 'DISPID_SRCEEnginePrivate',
    'SPEI_SOUND_START', 'SP_VISEME_19', 'SAFTCCITT_ALaw_11kHzStereo',
    'SVF_Emphasis', 'eLEXTYPE_RESERVED6', 'DISPID_SADefaultFormat',
    'DISPID_SRGetPropertyNumber', 'SP_VISEME_16',
    'DISPID_SVEventInterests', 'DISPID_SPPFirstElement',
    'DISPID_SLWs_NewEnum', 'ISpeechGrammarRuleStateTransitions',
    'SPPARTOFSPEECH', 'SRCS_Enabled', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SPRFirstElement', 'eLEXTYPE_RESERVED7', 'DISPIDSPTSI',
    'DISPID_SVPause', 'DISPID_SPCLangId', 'SPINTERFERENCE',
    'eLEXTYPE_PRIVATE11', 'SREAllEvents', 'SpeechInterference',
    'DISPID_SDKSetStringValue', 'DISPID_SVEVoiceChange',
    'DISPID_SRGId', 'ISpEventSink', 'SPEI_ADAPTATION',
    'SDA_One_Trailing_Space', 'SpeechCategoryPhoneConverters',
    'DISPID_SABIBufferSize', 'ISpNotifyTranslator',
    '_ISpeechVoiceEvents', 'ISpeechTextSelectionInformation',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SpeechMemoryStream',
    'DISPID_SPAsItem', 'DISPID_SRGDictationLoad',
    'DISPID_SPERequiredConfidence', 'eLEXTYPE_PRIVATE3',
    'ISpPhoneticAlphabetSelection', 'SPWT_PRONUNCIATION',
    'SPFM_CREATE_ALWAYS', 'ISpRecoCategory', 'STSF_AppData',
    'ISpeechRecognizerStatus', 'DISPID_SGRSTPropertyValue',
    'ISpeechVoice', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SOTs_NewEnum', 'DISPID_SpeechRecognizer', 'SPRST_ACTIVE',
    'SPSVerb', 'SGRSTTDictation', 'SSFMCreateForWrite',
    'DISPID_SVSInputSentencePosition', 'DISPID_SpeechVoiceEvent',
    '_RemotableHandle', 'SAFTGSM610_22kHzMono',
    'DISPID_SRSetPropertyNumber', 'SDTAll', 'SSTTWildcard',
    'SPRECOCONTEXTSTATUS', 'DISPID_SLWLangId',
    'DISPID_SASFreeBufferSpace', 'SP_VISEME_14', 'SRESoundEnd',
    'SpResourceManager', 'SPBOOKMARKOPTIONS',
    'SAFTCCITT_ALaw_22kHzMono', 'SRAImport', 'SAFT48kHz8BitStereo',
    'SPSSuppressWord', 'SVEPhoneme', 'SGRSTTRule', 'SVPNormal',
    'ISpeechXMLRecoResult', 'ISpeechRecoGrammar',
    'SPFM_OPEN_READWRITE', 'ISpeechAudio',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRGRecoContext',
    'ISpRecoContext', 'DISPID_SpeechLexiconPronunciation',
    'SPWT_DISPLAY', 'DISPID_SRRSaveToMemory', 'SAFTADPCM_11kHzStereo',
    'SAFTADPCM_11kHzMono', 'DISPID_SBSWrite',
    'DISPID_SpeechPhraseElements', 'SRSInactive',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPEI_MIN_TTS',
    'SVESentenceBoundary', 'DISPID_SRGState',
    'DISPID_SpeechLexiconWord', 'SPAR_Medium', 'SPSMF_UPS',
    'IInternetSecurityMgrSite', 'DISPID_SpeechBaseStream',
    'SPFM_OPEN_READONLY', 'SGLexical', 'SPPS_Noncontent',
    'SGDSInactive', 'SPEVENTSOURCEINFO', 'ISpStreamFormat',
    'ISpAudio', 'DISPID_SVEWord', 'DISPID_SOTGetAttribute',
    'UINT_PTR', 'DISPID_SGRAddState', 'SSFMOpenReadWrite',
    'eLEXTYPE_PRIVATE14', 'SPSMF_SAPI_PROPERTIES', 'SASStop',
    'SAFT22kHz8BitMono', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRSNumberOfActiveRules', 'SPAS_CLOSED',
    'SPEI_END_SR_STREAM', 'SAFTADPCM_22kHzStereo', 'SASRun',
    'DISPID_SRCEHypothesis', 'DISPID_SOTCGetDataKey',
    'SpeechRuleAttributes', 'DISPID_SVSLastBookmarkId',
    'ISpSerializeState', 'DISPID_SLPLangId', 'SVP_15',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPPROPERTYINFO', 'SSFMOpenForRead',
    'SGPronounciation', 'SGRSTTWildcard', 'SVP_10', 'SRTStandard',
    'eLEXTYPE_USER', 'DISPID_SPIRule', 'DISPID_SVSpeak', 'SPAR_High',
    'SpeechVoicePriority', 'SpMMAudioIn', 'SPGS_DISABLED',
    'SPINTERFERENCE_TOOLOUD', 'SPPHRASEPROPERTY',
    'DISPID_SGRSTNextState', 'SSTTTextBuffer',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SVSInputWordLength',
    'DISPID_SpeechPhraseBuilder', 'ISpNotifySink',
    'DISPID_SGRAttributes', 'SVP_0', 'DISPID_SPARecoResult',
    'DISPID_SRRSetTextFeedback', 'SPEI_MAX_SR', 'SPVPRI_OVER',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpSharedRecoContext',
    'DISPID_SpeechGrammarRules', 'SVSFlagsAsync', 'eLEXTYPE_PRIVATE1',
    'DISPID_SLPType', 'SINone', 'SAFT8kHz8BitMono',
    'DISPID_SRCCreateGrammar', 'DISPID_SpeechGrammarRule',
    'ISpeechVoiceStatus', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPCT_SLEEP', 'DISPID_SPIAudioStreamPosition',
    'SAFTADPCM_22kHzMono', 'ISpeechLexiconPronunciation',
    'SECFIgnoreCase', 'DISPID_SOTDataKey', 'DISPID_SDKGetlongValue',
    'SRSInactiveWithPurge', 'SpeechRuleState', 'SREAudioLevel',
    'DISPID_SLPSymbolic', 'SpFileStream', 'DISPID_SLGenerationId',
    'ISpeechPhraseAlternate', 'DISPID_SpeechPhraseRule',
    'DISPID_SRGCmdLoadFromObject', 'SRAInterpreter',
    'DISPID_SRGCmdLoadFromResource', 'SPPS_RESERVED3', 'SPVISEMES',
    'SPPHRASERULE', 'SPWF_SRENGINE', 'DISPID_SpeechVoiceStatus',
    'DISPID_SLWWord', 'DISPID_SGRClear', 'SpeechGrammarTagWildcard',
    'SPEI_SR_PRIVATE', 'ISpeechGrammarRule', 'DISPID_SDKSetLongValue',
    'DISPID_SRRAlternates', 'SRERecoOtherContext', 'SPWF_INPUT',
    'DISPID_SGRSTWeight', 'DISPID_SOTCDefault', 'eLEXTYPE_PRIVATE17',
    'SPFILEMODE', 'DISPID_SpeechObjectToken', 'ISpeechGrammarRules',
    'DISPID_SGRAddResource', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRGCmdSetRuleIdState', 'ISpeechCustomStream',
    'SPEI_RECO_STATE_CHANGE', 'SREStreamStart', 'SP_VISEME_5',
    'SpMemoryStream', 'SVSFPersistXML',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechPhraseReplacements', 'SpeechTokenIdUserLexicon',
    'DISPID_SPRNumberOfElements', 'SPSHT_EMAIL',
    'DISPID_SPCPhoneToId', 'SPEI_TTS_BOOKMARK', 'STSF_LocalAppData',
    'ISpXMLRecoResult', 'SPEI_PHRASE_START', 'SpObjectToken',
    'DISPID_SPPId', 'ISpStreamFormatConverter', 'Library',
    'DISPID_SRCVoice', 'SPWAVEFORMATTYPE', 'STCInprocServer',
    'ISpeechPhraseInfo', 'SPVOICESTATUS', 'SITooQuiet',
    'SpeechGrammarTagDictation', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SVSyncronousSpeakTimeout', 'SPPS_Interjection',
    'DISPID_SpeechMMSysAudio', 'DISPID_SVSInputSentenceLength',
    'ISpPhrase', 'DISPID_SLGetPronunciations', 'SRATopLevel',
    'SAFT48kHz16BitMono', 'DISPID_SPPs_NewEnum',
    'DISPID_SPRuleFirstElement', 'SAFTADPCM_8kHzStereo',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpeechFileStream',
    'DISPID_SRRGetXMLResult', 'ISpMMSysAudio', 'ISpStream',
    'ISpeechPhraseProperties', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SVEEnginePrivate', 'SAFT11kHz16BitStereo', 'SVP_9',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SGRSTransitions',
    'DISPID_SGRsFindRule', 'SPRULESTATE', 'SPEI_UNDEFINED',
    'ISpeechResourceLoader', 'eLEXTYPE_USER_SHORTCUT', 'SPEVENTENUM',
    'DISPID_SPEsCount', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SLWType', 'ISpObjectTokenCategory', 'DISPID_SAVolume',
    'DISPID_SRGSetWordSequenceData', 'SpShortcut', 'SPEI_HYPOTHESIS',
    ...
    'SAFT24kHz16BitStereo', 'DISPID_SPAs_NewEnum', 'DISPID_SOTId',
    'SPEI_SR_RETAINEDAUDIO', 'SPWORDPRONOUNCEABLE', 'DISPID_SPPValue',
    'DISPID_SVAudioOutput', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRSetPropertyString', 'SpeechRecoContextState',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SpeechRecoContextEvents',
    'SDTAlternates', 'DISPID_SOTCId', 'DISPID_SDKSetBinaryValue',
    'DISPID_SDKEnumKeys', 'SpeechDataKeyLocation',
    'ISpeechObjectTokens', 'SPRS_INACTIVE',
    'DISPIDSPTSI_SelectionLength', 'SVSFIsXML',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRRSpeakAudio', 'SRAONone',
    'DISPID_SBSFormat', 'SRTExtendableParse',
    'DISPID_SRCEStartStream', 'SVP_20', 'SpeechVoiceSkipTypeSentence',
    'ISpPhraseAlt', 'SPCS_ENABLED', 'DISPID_SRCEBookmark',
    'eWORDTYPE_DELETED', 'DISPID_SPPsCount',
    'SpeechPropertyNormalConfidenceThreshold',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'eLEXTYPE_PRIVATE16',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SMSSetData',
    'SPEI_VOICE_CHANGE', 'ISpDataKey', 'SpeechRecognitionType',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechTokenContext', 'SpMMAudioEnum',
    'SVSFParseSapi', 'SpeechCategoryAppLexicons', 'SpeechRunState',
    'DISPID_SRRTStreamTime', 'DISPID_SPELexicalForm',
    'SPBINARYGRAMMAR', 'SPAR_Unknown', 'SpeechGrammarWordType',
    'SPRST_INACTIVE_WITH_PURGE', 'SRAExport', 'eLEXTYPE_RESERVED9',
    'SAFT48kHz16BitStereo', 'IInternetSecurityManager',
    'SpeechCategoryRecoProfiles', 'SPEI_START_INPUT_STREAM',
    'SPFM_NUM_MODES', 'SP_VISEME_2', 'SpeechPropertyResponseSpeed',
    'DISPID_SPPsItem', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SPEDisplayAttributes', 'DISPID_SOTCSetId',
    'ISpResourceManager', 'DISPID_SpeechFileStream',
    'DISPID_SPPEngineConfidence', 'SPLEXICONTYPE', 'SDTPronunciation',
    'SPLO_DYNAMIC', 'ISpeechPhraseAlternates', 'SP_VISEME_21',
    'SPSNoun', 'DISPID_SWFESamplesPerSec', 'ISpeechPhraseRule',
    'SpeechCategoryVoices', 'DISPID_SOTCreateInstance', 'SPSUnknown',
    'SVP_13', 'ISequentialStream', 'DISPID_SPRsCount',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpeechLexiconPronunciations',
    'SDKLCurrentConfig', 'SpMMAudioOut', 'DISPID_SVGetVoices',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SOTRemoveStorageFileName', 'SAFT11kHz8BitStereo',
    'Speech_Default_Weight', 'DISPID_SOTSetId', 'SVSFIsFilename',
    'SECHighConfidence', 'DISPID_SVEBookmark',
    'SAFTExtendedAudioFormat', 'SWPUnknownWordPronounceable',
    'SLTUser', 'DISPID_SpeechLexiconWords', 'ISpPhoneConverter',
    'SVSFParseMask', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SGRsCount', 'DISPID_SGRId', 'DISPID_SRGCommit',
    'SPEI_SOUND_END', 'DISPID_SPPConfidence',
    ...
    'DISPID_SPIStartTime', 'SVEEndInputStream',
    'DISPID_SVSLastResult', 'DISPID_SPACommit', 'ISpeechWaveFormatEx',
    'DISPID_SPRulesCount', 'ISpeechPhraseReplacements',
    ...
    'eLEXTYPE_PRIVATE12', 'SPPS_RESERVED1', 'SWTAdded',
    'ISpeechPhraseInfoBuilder', 'SLOStatic', 'DISPID_SRStatus',
    'DISPID_SOTIsUISupported', 'SpeechAudioFormatGUIDText',
    'DISPID_SPRsItem', 'DISPID_SPEAudioSizeBytes', 'SVP_21',
    'SPSTREAMFORMATTYPE', 'DISPID_SVPriority', 'DISPID_SRDisplayUI',
    'SPSHT_Unknown', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE5', 'IStream', 'SPAUDIOSTATUS',
    'SpeechRetainedAudioOptions', 'SPRS_ACTIVE_USER_DELIMITED',
    'SVEVoiceChange', 'DISPID_SPIProperties', 'DISPID_SPIEngineId',
    'STCRemoteServer', 'SPEI_RESERVED5', 'SAFT24kHz8BitMono',
    'DISPID_SMSAMMHandle', 'SGDSActiveWithAutoPause',
    'SpeechAudioState', 'tagSPPROPERTYINFO', 'SREPropertyNumChange',
    'SFTInput', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SVStatus',
    'SDKLLocalMachine', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SGRSTPropertyId', 'DISPID_SGRsCommit',
    'DISPID_SpeechAudioFormat', 'ISpeechLexicon', 'SVSFVoiceMask',
    'tagSPTEXTSELECTIONINFO', 'SVEAudioLevel', 'DISPID_SPIElements',
    'SPPS_LMA', 'eLEXTYPE_PRIVATE20', 'ISpeechPhraseElements',
    'SPDKL_DefaultLocation', 'DISPID_SpeechRecoResultTimes',
    'SPEI_MIN_SR', 'DISPID_SpeechRecoResult', 'SITooLoud', 'SRARoot',
    'DISPID_SpeechPhraseInfo', 'SpeechAudioFormatGUIDWave',
    'SAFT32kHz8BitMono', 'SpeechRecognizerState',
    'DISPID_SOTMatchesAttributes', 'SPINTERFERENCE_LATENCY_WARNING',
    'SRCS_Disabled', 'SpeechEngineConfidence',
    'SDA_No_Trailing_Space', 'SAFTCCITT_ALaw_22kHzStereo',
    'SAFTCCITT_ALaw_44kHzMono', 'SAFTNoAssignedFormat',
    'DISPID_SOTCEnumerateTokens', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SRRecognizer', 'SpeechAddRemoveWord', 'SPAO_NONE',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPEEngineConfidence',
    'DISPID_SASState', 'DISPID_SPIGrammarId', 'SECFDefault',
    'SPDKL_CurrentUser', 'SPEI_END_INPUT_STREAM', 'SVP_17',
    'SPRST_NUM_STATES', 'SpCompressedLexicon',
    'SPINTERFERENCE_TOOQUIET', 'SPPHRASE', 'SRTSMLTimeout',
    'DISPID_SVEAudioLevel', 'SVP_5', 'DISPID_SPRuleName',
    'ISpRecoContext2', 'DISPID_SRCBookmark', 'SAFT48kHz8BitMono',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRGIsPronounceable',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRGetFormat', 'SLODynamic',
    'SGDSActiveUserDelimited', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRCEInterference', 'DISPID_SOTsItem', 'DISPID_SGRsAdd',
    'DISPID_SFSOpen', 'DISPID_SpeechRecoContext', 'SECFEmulateResult',
    'DISPID_SPPChildren', 'SGSEnabled', 'DISPID_SWFEBitsPerSample',
    'SVF_None', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SPEs_NewEnum', 'SAFTGSM610_8kHzMono', 'SPBO_NONE',
    'STSF_FlagCreate', 'SpeechUserTraining', 'DISPID_SLWsCount',
    'SPCS_DISABLED', 'SpeechPropertyHighConfidenceThreshold',
    'SAFT12kHz8BitStereo', 'SAFTADPCM_44kHzMono',
    'ISpeechAudioFormat', 'ISpeechRecoResultTimes',
    'ISpeechRecoContext', 'DISPID_SVVolume',
    'DISPID_SRGDictationSetState', 'SPWORDLIST',
    'DISPID_SRCEAudioLevel', 'SpeechDiscardType',
    'SPEI_TTS_AUDIO_LEVEL', 'SPPS_Verb', 'eLEXTYPE_APP',
    'SPRECOGNIZERSTATUS', 'DISPID_SDKDeleteKey', 'SRTReSent',
    'SP_VISEME_12', 'SVSFParseAutodetect', 'DISPID_SVWaitUntilDone',
    'DISPID_SLGetGenerationChange', 'DISPID_SRCResume',
    'DISPID_SFSClose', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRCERecognition', 'DISPID_SRAudioInputStream',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPPName',
    'DISPID_SVSkip', 'SpeechRegistryLocalMachineRoot', 'SP_VISEME_15',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpeechPhraseElement',
    'SPEI_RESERVED1', 'DISPID_SVEPhoneme',
    'SpeechCategoryRecognizers', 'DISPID_SVGetAudioInputs',
    'DISPID_SRRPhraseInfo', 'DISPID_SRGDictationUnload', 'SVP_18',
    'SPRST_INACTIVE', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPRuleChildren', '_SPAUDIOSTATE', 'DISPID_SRProfile',
    'ISpeechGrammarRuleStateTransition', 'SVP_4', 'SPEI_SR_BOOKMARK',
    'SREPhraseStart', 'SPDATAKEYLOCATION', 'SPSHT_NotOverriden',
    'SpLexicon', 'SPAUDIOBUFFERINFO', 'SPPS_Noun', 'SRSEIsSpeaking',
    'DISPIDSPTSI_SelectionOffset', 'Speech_Max_Word_Length',
    'SPDKL_LocalMachine', 'DISPID_SGRSTPropertyName',
    'DISPID_SRCEAdaptation', 'SECNormalConfidence',
    'SPCT_SUB_COMMAND', 'ISpNotifySource', 'SpInprocRecognizer',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SRSActive', 'SAFTADPCM_8kHzMono',
    'eLEXTYPE_PRIVATE2', 'SVP_1', 'DISPID_SpeechPhoneConverter',
    'SAFT16kHz8BitMono', 'SPAUDIOOPTIONS',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPRules_NewEnum', 'SAFTNonStandardFormat', 'SBONone',
    'DISPID_SRCCmdMaxAlternates', 'SPXRO_Alternates_SML',
    ...
    'DISPID_SAFType', 'SRADefaultToActive', 'SDTReplacement',
    'SVP_16', 'DISPIDSPRG', 'DISPID_SRRDiscardResultInfo',
    'STCLocalServer', 'SAFT32kHz8BitStereo', 'SAFTADPCM_44kHzStereo',
    'SPAO_RETAIN_AUDIO', 'ISpeechPhraseRules', 'SPGRAMMARSTATE',
    'DISPID_SpeechAudio', 'SpeechPropertyResourceUsage',
    'ISpObjectWithToken', 'eLEXTYPE_PRIVATE4', 'ISpRecognizer2',
    'DISPID_SRCESoundEnd', 'DISPID_SpeechGrammarRuleState',
    'SRADynamic', 'eLEXTYPE_PRIVATE19', 'DISPID_SGRsDynamic',
    'SpAudioFormat', 'DISPID_SABIEventBias',
    'SSSPTRelativeToCurrentPosition', 'SVEAllEvents',
    'SpeechAudioFormatType', 'SpStream', 'SpeechTokenShellFolder',
    'DISPID_SGRSRule', 'SPWORDPRONUNCIATIONLIST', 'SPSHORTCUTPAIR',
    'DISPID_SPEActualConfidence', 'SWPKnownWordPronounceable',
    'SPAR_Low', 'SPAS_RUN', 'ISpObjectToken', 'SDKLDefaultLocation',
    'eWORDTYPE_ADDED', 'DISPID_SPIEnginePrivateData',
    'DISPID_SGRSAddWordTransition', 'SP_VISEME_7',
    'SpeechTokenValueCLSID', 'SPXRO_SML', 'SRTEmulated',
    'DISPID_SRCRetainedAudio', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SpeechObjectTokenCategory', 'SPSEMANTICFORMAT',
    'SPEI_MAX_TTS', 'SPPS_Modifier', 'WAVEFORMATEX',
    'SPEI_REQUEST_UI', 'SP_VISEME_13', 'SPPS_NotOverriden',
    'SPSNotOverriden', 'SVP_3', 'SDKLCurrentUser', 'DISPID_SVRate',
    'DISPID_SDKGetStringValue', 'SPGS_ENABLED',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SOTRemove',
    'DISPID_SRRTLength', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SASClosed', 'DISPID_SPIGetText', 'SAFT12kHz8BitMono',
    'DISPID_SMSGetData', 'SINoise', 'SVEBookmark', 'SpeechRecoEvents',
    'DISPID_SPAsCount', 'DISPID_SRRAudioFormat', 'eLEXTYPE_PRIVATE15',
    'SPVPRI_NORMAL', 'SpeechAudioVolume', 'ISpGrammarBuilder',
    ...
    'SAFT44kHz8BitStereo', 'SpeechStreamFileMode',
    'SpInProcRecoContext', 'DISPID_SRGetPropertyString',
    'SpNullPhoneConverter', 'SpPhoneConverter', 'SAFT44kHz8BitMono',
    'DISPID_SPAStartElementInResult', 'DISPID_SRRAudio', 'SVP_14',
    'DISPID_SGRs_NewEnum', 'DISPID_SLGetWords', 'SpeechTokenKeyFiles',
    'DISPID_SpeechVoice', 'DISPID_SVSpeakStream', 'SPBO_PAUSE',
    'DISPID_SPAPhraseInfo', 'DISPID_SREmulateRecognition',
    'SpeechRegistryUserRoot', 'SPCT_COMMAND',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechLexiconType',
    'DISPID_SRSClsidEngine', 'eLEXTYPE_RESERVED8',
    'DISPID_SVSVisemeId', 'ISpLexicon', 'SVPAlert',
    'SPSEMANTICERRORINFO', 'DISPID_SRRRecoContext',
    'DISPID_SRGCmdSetRuleState', 'SREPrivate',
    'ISpeechAudioBufferInfo', 'DISPID_SPEsItem',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRSCurrentStreamPosition', 'SPGRAMMARWORDTYPE',
    'SPGS_EXCLUSIVE', 'DISPID_SPRuleEngineConfidence', 'SVPOver',
    'SpTextSelectionInformation', 'SpeechFormatType', 'SPSHT_OTHER',
    'STSF_CommonAppData', 'DISPID_SAEventHandle', 'SAFTDefault',
    ...
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechPhraseRules',
    'SPEI_PHONEME', 'SPSLMA', 'ISpRecoGrammar',
    'SpeechCategoryAudioIn', 'DISPID_SGRSTType', 'SECFIgnoreWidth',
    'SAFTText', 'ISpeechMMSysAudio', 'SGRSTTWord', 'SPPS_Function',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SASetState', 'SAFT32kHz16BitMono', 'SPINTERFERENCE_NONE',
    'SP_VISEME_4', 'DISPID_SRRTimes', 'SVEWordBoundary',
    'DISPIDSPTSI_ActiveLength', 'SpeechVoiceEvents',
    'SSSPTRelativeToEnd', '_ISpeechRecoContextEvents', 'SPRECOSTATE',
    'DISPID_SRGetRecognizers', 'SVEPrivate', 'SPBO_AHEAD',
    'SAFT22kHz8BitStereo', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPSInterjection', 'SAFT24kHz8BitStereo', 'tagSTATSTG',
    'DISPID_SRAudioInput', 'SAFT8kHz16BitStereo',
    'DISPID_SOTCategory', 'SPWORD', 'DISPID_SVIsUISupported',
    'SpeechStreamSeekPositionType', 'eLEXTYPE_PRIVATE18',
    'SVSFDefault', 'SpeechVisemeType', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SPIGetDisplayAttributes', 'SpWaveFormatEx',
    'SpeechAllElements', 'LONG_PTR', 'ISpRecoResult',
    'eLEXTYPE_PRIVATE6', 'DISPID_SVSLastBookmark', 'SpeechTokenKeyUI',
    'SPRS_ACTIVE', 'DISPID_SABIMinNotification', 'SVP_2',
    'SPEI_RESERVED2', 'DISPID_SPRuleConfidence', 'SPBO_TIME_UNITS',
    'eLEXTYPE_VENDORLEXICON', 'SpeechVisemeFeature',
    'DISPID_SRCRecognizer', 'SRAORetainAudio', 'IEnumString',
    'Speech_StreamPos_Asap', 'SREHypothesis', 'SP_VISEME_17',
    'SpeechDisplayAttributes', 'DISPID_SPPNumberOfElements',
    'DISPID_SRState', 'DISPID_SPEDisplayText', 'ISpeechLexiconWords',
    'DISPID_SWFEBlockAlign', 'DISPID_SpeechRecoResult2',
    'DISPID_SGRSTsCount', 'DISPID_SABufferInfo', 'SPVPRIORITY',
    'SBOPause', 'DISPID_SRCPause', 'SP_VISEME_9',
    'SAFT12kHz16BitStereo', 'DISPID_SRGRules',
    'Speech_Max_Pron_Length', 'eLEXTYPE_PRIVATE10',
    'SPPHRASEREPLACEMENT', 'DISPID_SAStatus', 'SP_VISEME_3',
    'SpObjectTokenCategory', 'ISpPhoneticAlphabetConverter',
    'typelib_path', 'DISPID_SRCERequestUI',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SGRName', 'STCAll',
    'SRSEDone', 'DISPID_SLWsItem', 'SGDisplay',
    'DISPID_SRSCurrentStreamNumber', 'SDTLexicalForm',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SASCurrentDevicePosition',
    'SPLO_STATIC', 'DISPID_SCSBaseStream', 'DISPID_SBSSeek',
    'DISPID_SpeechLexicon', 'SRTAutopause', 'DISPID_SMSADeviceId',
    'DISPID_SPRs_NewEnum', 'SPAUDIOSTATE', 'ISpShortcut',
    'SpCustomStream', 'DISPID_SDKCreateKey', 'SP_VISEME_18',
    ...
    'SREStreamEnd', 'DISPID_SMSALineId', 'DISPID_SPILanguageId',
    'DISPID_SVVoice', 'SVP_8', 'SVP_7', 'SpeechEmulationCompareFlags',
    'SAFTGSM610_44kHzMono', 'SpeechPropertyAdaptationOn',
    'DISPID_SRSSupportedLanguages', 'DISPID_SPCIdToPhone',
    'DISPID_SRGReset', 'DISPID_SDKDeleteValue', 'SPEI_RESERVED6',
    'eLEXTYPE_RESERVED10', 'SFTSREngine', 'SITooSlow',
    'SREInterference', 'SPWT_LEXICAL', 'SRSActiveAlways',
    'DISPID_SPISaveToMemory', 'SITooFast', 'ISpeechObjectToken',
    'DISPID_SRCEPropertyStringChange', 'ISpProperties',
    'SpeechAudioProperties', 'SPADAPTATIONRELEVANCE',
    'DISPID_SLPsItem', 'DISPID_SRCEPhraseStart',
    'DISPID_SRCRequestedUIType', 'SVP_12', 'DISPID_SGRSTText',
    'DISPID_SpeechObjectTokens', 'DISPID_SPEPronunciation',
    'SPWORDTYPE', 'SPVPRI_ALERT', 'SVSFNLPMask', 'SPEI_VISEME',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SGRsCommitAndSave', 'SVEViseme'
]

_check_version('1.3.1', 1719993710.928498)
